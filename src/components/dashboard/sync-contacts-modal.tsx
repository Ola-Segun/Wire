      ...
      >
        ...
        <div className="flex-1 overflow-hidden flex flex-col p-5">
          {loading ? (
            ...
            <>
              {/* WhatsApp: phone number input form */}
              {platform === "whatsapp" && (
                <div className="mb-4 p-4 border border-border/40 rounded-lg bg-accent/10">
                  ...
                  <div className="space-y-2">
                    <input
                      ...
                      className="w-full px-3 py-2 border border-border rounded-lg text-sm bg-card text-foreground focus:outline-none focus:border-primary/40 transition-all"
                    />
                    <input
                      type="text"
                    ...
                    <Button
                      ...
                      disabled={!whatsAppPhone.trim() || addingPhone}
                      size="sm"
                      className="w-full"
                    >
                      {addingPhone ? (
              ...
              {isEmpty && platform !== "whatsapp" ? (
                ...
                <p className="text-xs text-muted-foreground text-center py-4">
                  No unlinked WhatsApp contacts yet. Add one above!
                </p>
              ) : hasContacts ? (
                <>
                  <p className="text-xs text-muted-foreground mb-3">
                    {platform === "whatsapp"
                      ? `${contacts!.length} unlinked contact${contacts!.length !== 1 ? "s" : ""}. Select to link to a client.`
                      : `Found ${contacts!.length} new contact${contacts!.length !== 1 ? "s" : ""}. Select which ones to track.`}
                  </p>
