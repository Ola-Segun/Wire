...
export default async function LandingPage() {
  ...
  if (userId) {
    ...
    try {
      ...
      // If redirect() was called inside try, it throws a special Next.js error — rethrow it
      if (err instanceof Error && err.message === "NEXT_REDIRECT") throw err;
      console.error("Landing page: Convex query failed, redirecting to dashboard:", err);
    }
