...
const PLATFORM_CAPABILITIES: Record<string, {
  ...
  whatsapp: {
    messageTypes: ["WhatsApp messages (Twilio)"],
    features: ["Receive messages via webhook", "Send replies"],
    limitations: ["Requires Twilio account", "Phone number based"],
  },
};
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 animate-fade-in">
                ...
                <div className="flex items-center gap-2 flex-wrap justify-end">
                  {isConnected ? (
                    <>
                      ...
                      {(platform === "gmail" || platform === "slack" || platform === "discord") && (
                        <button
      ...
      {syncModalPlatform && user?._id && (
        <SyncContactsModal
          platform={syncModalPlatform as "gmail" | "slack" | "discord"}
          userId={user._id}
